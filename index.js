...
card.forEach(function(cards){
    ...
    div.innerHTML=` <i class="fa-solid fa-xmark" onclick="remove()"></i> <img src=${cards.firstElementChild.src}>
    <p>$199</p>`
...
function remove(){
    num--;
    let cartList=document.querySelectorAll(
        ".cartList");
...
submit.addEventListener("click",function(){
    ...
    if(email.value == "" && pass.value==""){
        alert("PLEASE ENTER EMAIL AND SAVE YOUR PASSWORD")
    }else{
        alert("THNXX YOU LOGGED IN")
    }
})